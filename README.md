...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_security_group"></a> [security\_group](#module\_security\_group) | git::https://github.com/Coalfire-CF/terraform-aws-securitygroup | v1.1.4 |
...
| <a name="input_backup_policy"></a> [backup\_policy](#input\_backup\_policy) | Backup policy tag value for EC2 instances and EBS volumes | `string` | `"aws-backup-minimum-compliance"` | no |
...
| <a name="input_resource_prefix"></a> [resource\_prefix](#input\_resource\_prefix) | Prefix to be used for resource naming | `string` | n/a | yes |
